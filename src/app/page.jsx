  ...
  return (
    ...
    <Nav/>
      ...
      <div className="w-full h-[1910px] bg-[url('/homeimages/arrow.svg')] bg-center bg-contain bg-gray-200  bg-no-repeat ">
          <div className="w-full text-center h-[200px] pt-20 text-black font-black text-[40px]"><h1 className="w-full h-[40px]">New Collection </h1></div>
        ...
        <div className="w-full h-[80px] flex justify-center ">
            ...
            <div className="w-full h-[93px] flex gap-[70px]  justify-center items-center  bg-black max-460:flex-wrap max-460:h-[262px] ">
          <Image src={adv1} alt="icon" />
          <Image src={adv2} alt="icon" />
          <Image src={adv3} alt="icon" />
          <Image src={adv4} alt="icon" />
          <Image src={adv5} alt="icon" />
            </div>
        ...
        <div className="w-full h-[170px] flex justify-center ">
            ...
            <section className="w-full h-[600px] flex justify-center items-center  bg-gray-200 max-460:items-start max-460:pt-3 max-460:h-[700px] ">
        <form className="w-[70%] h-[450px] max-460:flex-col     flex bg-white rounded-xl max-460:h-[680px] max-460:pt-[20px]">
